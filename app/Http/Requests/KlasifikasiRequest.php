...
class KlasifikasiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tipe' => 'required|in:pola_ruang,struktur_ruang,ketentuan_khusus,dokumen,kawasan_strategi_provinsi,data_spasial,batas_administrasi',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'tipe.in' => 'Tipe klasifikasi harus pola_ruang, struktur ruang, ketentuan khusus, dokumen, kawasan strategi provinsi, data_spasial, atau batas administrasi.',
        ];
    }
}
